...
to calc-pot-profit
  ...
  ask my-land [
    set profit-ext ln(1 + fertility) + base-p + bonus-wat * prox-river + bonus-agg * agg
    set profit-int ln(2 * (1 + fertility))
  ]
end
...
to calc-yield
  ...
  ask patches with [manag = "ext"] [
    set yield ln(1 + fertility)
  ]
  ask patches with [manag = "int"] [
    set yield ln(2 * (1 + fertility))
  ]
end
...
to calc-profit
  ...
  ask my-land [
    ifelse manag = "ext" [
      set profit ln(1 + fertility) + base-p + bonus-wat * prox-river + bonus-agg * agg
    ][
      set profit ln(2 * (1 + fertility))
    ]
  ]
end
